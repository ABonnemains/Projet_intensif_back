...
CREATE TABLE IF NOT EXISTS `roule_ma_poule`.`utilisateur` (
  ...
  `utilisateur_portable` VARCHAR(45) NOT NULL,
  ...
  `utilisateur_token` VARCHAR(45) NOT NULL,
  `utilisateur_handicap_type` VARCHAR(20) NULL,
...
CREATE TABLE IF NOT EXISTS `roule_ma_poule`.`trajet` (
  ...
  `trajet_depart` VARCHAR(45) NOT NULL,
  `trajet_arrivee` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `roule_ma_poule`.`evenement` (
  ...
  `evenement_lieu` VARCHAR(45) NOT NULL,
