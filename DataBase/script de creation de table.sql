...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `utilisateur_handicape` TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `utilisateur_evenement` (
  ...
  `utilisateur_evenement_utilisateur_id` INT UNSIGNED NOT NULL,
  `utilisateur_evenement_evenement_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `note_obstacle` (
  ...
  `note_obstacle_note` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `note_trajet` (
  `note_trajet_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE UNIQUE INDEX `note_trajet_id_UNIQUE` ON `note_trajet` (`note_trajet_id` ASC);
